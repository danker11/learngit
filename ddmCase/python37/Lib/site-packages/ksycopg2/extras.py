...
class UUID_adapter(object):
    ...
    .. __: https://www.kingbase.org/docs/current/static/datatype-uuid.html
    """
...
class HstoreAdapter(object):
    ...
    def _getquoted_8(self):
        """Use the operators available in KB pre-9.0."""
        if not self.wrapped:
            return b"''::hstore"
    ...
    def get_oids(self, conn_or_curs):
        ...
        curs.execute("""\
SELECT t.oid, %s
FROM sys_type t JOIN sys_catalog.sys_namespace ns
...
FROM sys_type t
JOIN sys_catalog.sys_namespace ns ON typnamespace = ns.oid
JOIN sys_catalog.sys_attribute a ON attrelid = typrelid
...
def execute_values(cur, sql, argslist, template=None, page_size=100, fetch=False):
    ...
    .. __: https://www.kingbase.org/docs/current/static/queries-values.html
